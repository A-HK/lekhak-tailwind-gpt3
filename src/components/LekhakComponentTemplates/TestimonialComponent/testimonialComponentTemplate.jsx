        ...
        <div className="max-w-7xl mx-auto md:grid md:grid-cols-2 md:px-6 lg:px-8">
          <div className="py-12 px-4 sm:px-6 md:flex md:flex-col md:py-16 md:pl-0 md:pr-10 md:border-r md:border-teal-900 lg:pr-16">
            <div className="md:flex-shrink-0">
                ...
                <p className="text-white font-bold text-lg uppercase align-middle tracking-widest inline-block p-2">Tuple</p>
            </div>
            <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
              <div className="relative text-lg font-medium text-white md:flex-grow">
                <svg
                  className="absolute top-0 left-0 transform -translate-x-3 -translate-y-2 h-8 w-8 text-teal-600"
                  fill="currentColor"
                  viewBox="0 0 32 32"
                  aria-hidden="true"
                >
              ...
              <footer className="mt-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <div className="text-base font-medium text-teal-200">CEO, Tuple</div>
                  </div>
                </div>
              </footer>
            </blockquote>
          ...
          <div className="py-12 px-4 border-t-2 border-teal-900 sm:px-6 md:py-16 md:pr-0 md:pl-10 md:border-t-0 md:border-l lg:pl-16">
            <div className="md:flex-shrink-0">
              <GlobeAltIcon className="h-10 w-10 text-white inline-block" />
              <p className="text-white font-bold text-lg uppercase align-middle tracking-widest inline-block p-2">Workcation</p>
            </div>
            <blockquote className="mt-6 md:flex-grow md:flex md:flex-col">
              <div className="relative text-lg font-medium text-white md:flex-grow">
                <svg
              ...
              <footer className="mt-8">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <div className="text-base font-medium text-teal-200">CEO, Workcation</div>
                  </div>
                </div>
              </footer>
            </blockquote>
